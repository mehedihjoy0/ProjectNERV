...
SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION=eq_custom,uhq_onoff,karaoke,adapt,spk_stereo,dvfs_30_percent,dolby_game_spk_off
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_VENDOR_LIB_INFO=beauty.samsung.v4,face_landmark.arcsoft.v2_1,facial_attribute.samsung.v1,food.samsung.v1,human_tracking.arcsoft.v2_1,smart_scan.samsung.v2,aimode.samsung.v1,dual_bokeh.samsung.v1_1,single_bokeh.samsung.v2,swuwdc.arcsoft.v1,image_codec.samsung.v1,mfhdr.arcsoft.v1,llhdr.arcsoft.v1,localtm.samsung.v1_1,selfie_correction.samsung.v1,event_detection.samsung.v2,image_enhance.arcsoft.v1
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_DEX_MODE=dual,wireless
...
SEC_FLOATING_FEATURE_GALLERY_CONFIG_LIVEFOCUS_EFFECT_DUAL_BOKEH=BLUR,EFFECT,BIGBOKEH,PORTRAIT,RELIGHT,REFOCUS,LIGHT360,PL_360

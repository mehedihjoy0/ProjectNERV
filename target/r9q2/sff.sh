...
# SEC Floating Feature configuration file for Galaxy S21 FE 5G (Snapdragon) (r9q2)
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_WALLPAPER_STYLE=MOTION,VIDEO,GENWEATHER

# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy S21 FE 5G
SEC_FLOATING_FEATURE_SECURITY_SUPPORT_STRONGBOX=TRUE
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG990B2
